...
const ChatTile = React.forwardRef(
  function(props:IChatTileProps,ref){
    return (
         <div ref={ref} onClick={props.navigate} className={`${props.active?"bg-stone-100 dark:bg-gray-600":""} room  cursor-pointer px-6 py-4 flex flex-row hover:bg-stone-100 transition-colors shadow-sm
