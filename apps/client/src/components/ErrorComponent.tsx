...
export default function ErrorComponent(props: IErrorComponent) {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center bg-white dark:bg-gray-800 mb-8">
      <PCSvg/>
      <div className="flex flex-col items-center justify-center">
        <p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-gray-600 dark:text-white mt-8">500</p>
        <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-600 dark:text-white mt-2">Server Error</p>
        <p className="md:text-lg xl:text-xl text-center text-gray-500 dark:text-gray-100 mt-4">Whoops, something went wrong on our servers.</p>
      </div>
      <button onClick={props.resolve} className="mt-6 bg-emerald-600 hover:bg-emerald-700 dark:bg-emerald-800 dark:hover:bg-emerald-900 text-white font-bold py-2 px-4 flex flex-row items-center rounded-full">
        <TfiReload/>&nbsp;Reload
      </button>
    </div>);
}
...
export function PageNotFoundError(props: IErrorComponent) {
