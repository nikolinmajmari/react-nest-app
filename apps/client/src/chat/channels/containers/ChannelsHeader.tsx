...
export default function ChannelsHeader(){
    ...
    return (
        <div className='header py-5 bg-white bg-opacity-10 sticky top-0 backdrop-blur-xl flex flex-row items-center h-25 dark:bg-gray-950 dark:bg-opacity-30 dark:shadow-xl'>
                <input className='flex-1 mx-5 shadow-sm outline-none transition-colors rounded-2xl bg-slate-50 focus:bg-teal-50 focus:shadow-md px-4 py-2 dark:bg-slate-700 dark:focus:bg-slate-800 dark:text-white'/>
